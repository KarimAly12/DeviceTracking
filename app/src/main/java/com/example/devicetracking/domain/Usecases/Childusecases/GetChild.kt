...
class GetChild(private val repository: ChildRepository) {

    suspend operator fun invoke(childId:String, child: MutableState<Child>){

        return repository.getChild(childId, child)
    }
}